@echo off
chcp 65001 >nul
title Reinos de Aventura 1.0.0 - archivos del servidor
...
set FALLO=0
echo Descargando 85 mods (unos 300 MB)...
echo [1/85] AI Improvements: Performance Tuning
...
echo [25/85] Dragon Mounts: Legacy
...
echo [26/85] Dungeons and Taverns
...
echo [31/85] FriendsFoes (Forge/NeoForge)
...
echo [38/85] Iron's Spells 'n Spellbooks
...
echo [40/85] Just Enough Items (JEI)
...
echo [42/85] L_Ender's Cataclysm
...
echo [49/85] Moog's Structure Lib (moogs_structures)
...
echo [50/85] MVS - Moog's Voyager Structures
...
echo [55/85] Open Parties and Claims
...
echo [61/85] Repurposed Structures - Neoforge/Forge
...
echo [64/85] Sophisticated Backpacks
...
echo [72/85] Traveler's Backpack
...
echo [74/85] When Dungeons Arise
...
echo [78/85] YUNG's Better Desert Temples
...
echo [79/85] YUNG's Better Dungeons
...
echo [80/85] YUNG's Better Mineshafts
...
echo [81/85] YUNG's Better Nether Fortresses
...
echo [82/85] YUNG's Better Ocean Monuments
...
echo [83/85] YUNG's Better Strongholds
