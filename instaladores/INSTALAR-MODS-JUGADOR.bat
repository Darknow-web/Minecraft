@echo off
chcp 65001 >nul
title Reinos de Aventura 1.1.0 - instalador de mods
echo ==========================================================
echo   REINOS DE AVENTURA 1.1.0 - Instalador para jugadores
echo ==========================================================
echo.
...
mkdir "%MODS%"
set FALLO=0
echo Descargando 95 mods (unos 310 MB, solo la primera vez)...
echo [1/95] AI Improvements: Performance Tuning
...
echo [11/95] Better Advancements
...
echo [27/95] Dragon Mounts: Legacy
...
echo [28/95] Dungeons and Taverns
...
echo [35/95] FriendsFoes (Forge/NeoForge)
...
echo [43/95] Iron's Spells 'n Spellbooks
...
echo [45/95] Just Enough Items (JEI)
...
echo [48/95] L_Ender's Cataclysm
...
echo [49/95] Lightman's Currency
...
echo [56/95] Moog's Structure Lib (moogs_structures)
...
echo [57/95] MVS - Moog's Voyager Structures
...
echo [63/95] Open Parties and Claims
...
echo [69/95] Repurposed Structures - Neoforge/Forge
...
echo [74/95] Sophisticated Backpacks
...
echo [82/95] Traveler's Backpack
...
echo [84/95] When Dungeons Arise
...
echo [88/95] YUNG's Better Desert Temples
...
echo [89/95] YUNG's Better Dungeons
...
echo [90/95] YUNG's Better Mineshafts
...
echo [91/95] YUNG's Better Nether Fortresses
...
echo [92/95] YUNG's Better Ocean Monuments
...
echo [93/95] YUNG's Better Strongholds
